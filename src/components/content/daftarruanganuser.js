...
class Daftarruanganuser extends Component{
    constructor(props) {
      super(props);
      this.state = {
      nimc:'',
          ...
          <div className="kotakfilter"> 
            <form className="kotakforminputlogpintu" onSubmit={this.handleSubmit}>
              ...
              <div className="kotakinputpenggunanama">
                ...
                <input name="idc" onChange={this.handleChange} className="inputformpenggunanama" type="text" placeholder="Nama" required ></input>
              </div> 
...
export default withRouter(Daftarruanganuser);